...
public:
	...
	static constexpr std::string_view thread_name = "Signaling Manager Thread";
...
private:
	...
	// WARNING! This value should be cast to BigEndian before use!
	...
	{
		u32 signature = (u32_be)SIGNALING_SIGNATURE;
