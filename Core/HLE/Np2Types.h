...
enum PSPMatching2RequestEvent
{
	...
	SCE_NP_MATCHING2_REQUEST_EVENT_UNKNOWN = 0xa102,
};

enum NpMatching2ResponseEvent
{
	SCE_NP_MATCHING2_RESPONSE_EVENT_Empty = 0x0000,
	SCE_NP_MATCHING2_RESPONSE_EVENT_GetServerInfo = 0x1001,
	SCE_NP_MATCHING2_RESPONSE_EVENT_ = 0x1002, // np_matching2.prx 0x00006d50
	SCE_NP_MATCHING2_RESPONSE_EVENT_GetWorldInfoList = 0x1008,
	SCE_NP_MATCHING2_RESPONSE_EVENT_SetUserInfo = 0x1006,
	SCE_NP_MATCHING2_RESPONSE_EVENT_GetUserInfoList = 0x1007,

	SCE_NP_MATCHING2_RESPONSE_EVENT_GetRoomMemberDataExternalList = 0x1206,
	SCE_NP_MATCHING2_RESPONSE_EVENT_SetRoomDataExternal = 0x1207,
	SCE_NP_MATCHING2_RESPONSE_EVENT_GetRoomDataExternalList = 0x1208,

	SCE_NP_MATCHING2_RESPONSE_EVENT_CreateJoinRoom = 0x1209,
	SCE_NP_MATCHING2_RESPONSE_EVENT_JoinRoom = 0x1209,
	SCE_NP_MATCHING2_RESPONSE_EVENT_LeaveRoom = 0x3202,
	SCE_NP_MATCHING2_RESPONSE_EVENT_GrantRoomOwner = 0x3210,
	SCE_NP_MATCHING2_RESPONSE_EVENT_KickoutRoomMember = 0x3211,
	SCE_NP_MATCHING2_RESPONSE_EVENT_SearchRoom = 0x1200,
	SCE_NP_MATCHING2_RESPONSE_EVENT_SearchRoomWithOption = 0x120c,
	SCE_NP_MATCHING2_RESPONSE_EVENT_SendRoomChatMessage = 0x3208,
	SCE_NP_MATCHING2_RESPONSE_EVENT_SendRoomMessage = 0x320a,
	SCE_NP_MATCHING2_RESPONSE_EVENT_SetRoomDataInternal = 0x3204,
	SCE_NP_MATCHING2_RESPONSE_EVENT_GetRoomDataInternal = 0x3205,
	SCE_NP_MATCHING2_RESPONSE_EVENT_SetRoomMemberDataInternal = 0x3206,
	SCE_NP_MATCHING2_RESPONSE_EVENT_GetRoomMemberDataInternal_alt = 0x3207,
	SCE_NP_MATCHING2_RESPONSE_EVENT_GetRoomMemberDataInternalList = 0x3203,
	SCE_NP_MATCHING2_RESPONSE_EVENT_SetSignalingOptParam = 0x3204,
};
