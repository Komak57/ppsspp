...
#define SCE_NP_MATCHING2_ERROR_ALREADY_INITIALIZED				0x80550c01 
#define SCE_NP_MATCHING2_ERROR_NOT_INITIALIZED					0x80550c02 // Default return when Np2Init == 0
#define SCE_NP_MATCHING2_ERROR_INITIALIZE_FAILED				0x80550c03 // returned when sceSsl_lib_0xFB8273FE fails during Np2Init
#define SCE_NP_MATCHING2_ERROR_BAD_THREAD_STACK					0x80550c04 // sceKernelCheckThreadStack failure in sceNpMatching2SetRoomDataExternal
#define SCE_NP_MATCHING2_ERROR_CONTEXT_MAX						0x80550c05 // might be "Invalid Argument" on PSP?
#define SCE_NP_MATCHING2_ERROR_CONTEXT_ALREADY_EXISTS			0x80550c07 // might be "Context Max/Context Id higher than 7" on PSP?
...
#define SCE_NP_MATCHING2_ERROR_INVALID_REQUEST_ID				0x80550c17 // Related to sceNpMatching2AbortRequest
...
#define SCE_NP_MATCHING2_SIGNALING_ERROR_MATCHING2_PEER_CONN_FAILED		0x80550e1a // guess
#define SCE_NP_MATCHING2_SIGNALING_ERROR_MATCHING2_PEER_TIMEOUT			0x80550e1b // guess
#define SCE_NP_MATCHING2_SIGNALING_ERROR_MATCHING2_PEER_EXPIRED			0x80550e1c // guess

enum SceNpMatching2EventType : u16
{
...
//{
//	PS3_SCE_NP_MATCHING2_REQUEST_EVENT_Empty = 0x0000,
//	PS3_SCE_NP_MATCHING2_REQUEST_EVENT_GetServerInfo = 0x0001,
//	PS3_SCE_NP_MATCHING2_REQUEST_EVENT_GetWorldInfoList = 0x0002,
//	PS3_SCE_NP_MATCHING2_REQUEST_EVENT_GetRoomMemberDataExternalList = 0x0003,
//	PS3_SCE_NP_MATCHING2_REQUEST_EVENT_SetRoomDataExternal = 0x0004,
//	PS3_SCE_NP_MATCHING2_REQUEST_EVENT_GetRoomDataExternalList = 0x0005,
//	PS3_SCE_NP_MATCHING2_REQUEST_EVENT_GetLobbyInfoList = 0x0006,
//	PS3_SCE_NP_MATCHING2_REQUEST_EVENT_SetUserInfo = 0x0007,
//	PS3_SCE_NP_MATCHING2_REQUEST_EVENT_GetUserInfoList = 0x0008,
//	PS3_SCE_NP_MATCHING2_REQUEST_EVENT_CreateServerContext = 0x0009,
//	PS3_SCE_NP_MATCHING2_REQUEST_EVENT_DeleteServerContext = 0x000a,
//	PS3_SCE_NP_MATCHING2_REQUEST_EVENT_CreateJoinRoom = 0x0101,
//	PS3_SCE_NP_MATCHING2_REQUEST_EVENT_JoinRoom = 0x0102,
//	PS3_SCE_NP_MATCHING2_REQUEST_EVENT_LeaveRoom = 0x0103,
//	PS3_SCE_NP_MATCHING2_REQUEST_EVENT_GrantRoomOwner = 0x0104,
//	PS3_SCE_NP_MATCHING2_REQUEST_EVENT_KickoutRoomMember = 0x0105,
//	PS3_SCE_NP_MATCHING2_REQUEST_EVENT_SearchRoom = 0x0106,
//	PS3_SCE_NP_MATCHING2_REQUEST_EVENT_SendRoomChatMessage = 0x0107,
//	PS3_SCE_NP_MATCHING2_REQUEST_EVENT_SendRoomMessage = 0x0108,
//	PS3_SCE_NP_MATCHING2_REQUEST_EVENT_SetRoomDataInternal = 0x0109,
//	PS3_SCE_NP_MATCHING2_REQUEST_EVENT_GetRoomDataInternal = 0x010a,
//	PS3_SCE_NP_MATCHING2_REQUEST_EVENT_SetRoomMemberDataInternal = 0x010b,
//	PS3_SCE_NP_MATCHING2_REQUEST_EVENT_GetRoomMemberDataInternal = 0x010c,
//	PS3_SCE_NP_MATCHING2_REQUEST_EVENT_SetSignalingOptParam = 0x010d,
//	PS3_SCE_NP_MATCHING2_REQUEST_EVENT_JoinLobby = 0x0201,
//	PS3_SCE_NP_MATCHING2_REQUEST_EVENT_LeaveLobby = 0x0202,
//	PS3_SCE_NP_MATCHING2_REQUEST_EVENT_SendLobbyChatMessage = 0x0203,
//	PS3_SCE_NP_MATCHING2_REQUEST_EVENT_SendLobbyInvitation = 0x0204,
//	PS3_SCE_NP_MATCHING2_REQUEST_EVENT_SetLobbyMemberDataInternal = 0x0205,
//	PS3_SCE_NP_MATCHING2_REQUEST_EVENT_GetLobbyMemberDataInternal = 0x0206,
