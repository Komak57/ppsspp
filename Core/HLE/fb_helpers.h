...
namespace np
{
	...
	void RoomMemberUpdateInfo_to_SceNpMatching2RoomMemberUpdateInfo(BlockAllocator& edata, const RoomMemberUpdateInfo* resp, PSPPointer<SceNpMatching2RoomMemberUpdateInfo> room_info, bool include_onlinename, bool include_avatarurl);
